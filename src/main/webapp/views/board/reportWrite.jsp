    ...
    <div class="xe">
        <div class="xe_width content-wrapper">
            ...
            <div class="write-area">
                ...
                <form name="reportForm" action="${pageContext.request.contextPath}/views/board/reportWrite.jsp" method="post" onsubmit="return validatePost()">
                    <!-- 제목 입력 -->
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="postContent" name="content" class="form-textarea" placeholder="신고 내용을 입력하세요 (최대 5000자)" maxlength="5000" rows="15" required></textarea>
                        <div class="char-counter">
